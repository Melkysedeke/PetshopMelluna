...
<head>
    ...
    <title>Editar Animal - PetShop Melluna 🐾</title>
...
<body>
    <%
        ...
        if (animal == null || !animal.getCpfCliente().equals(clienteLogado.getCpf())) {
    ...
    <div class="header">
        <h1>Editar Animal <i class="fas fa-paw icon"></i></h1>
        ...
        <form action="<%= request.getContextPath() %>/AnimalController" method="post">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="nome" name="nome" value="<%= animal.getNome() %>" required>
                </div>

                <div class="form-group">
                    <label for="especie">Espécie:</label>
                    <select id="especie" name="especie" required>
                        <option value="Cão" <%= "Cão".equals(animal.getEspecie()) ? "selected" : "" %>>Cão</option>
                        <option value="Gato" <%= "Gato".equals(animal.getEspecie()) ? "selected" : "" %>>Gato</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="raca">Raça:</label>
                    <input type="text" id="raca" name="raca" value="<%= animal.getRaca() != null ? animal.getRaca() : "" %>">
                </div>

                <div class="form-group">
                    <label for="peso">Peso (kg):</label>
                    <input type="number" id="peso" name="peso" step="0.01" min="0.1" value="<%= animal.getPeso() %>" required>
                </div>

                <div class="form-group full-width">
                    <label for="obs">Observações (opcional):</label>
                    <textarea id="obs" name="obs" rows="3"><%= animal.getObs() != null ? animal.getObs() : "" %></textarea>
                </div>
            </div>
